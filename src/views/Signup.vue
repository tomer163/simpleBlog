<template>
    <div class="m-8 relative h-[calc(100vh-90px)]">
        <div class="absolute w-full flex flex-col max-w-[400px] gap-4 left-0 right-0 mx-auto my-auto top-0 bottom-28 max-h-fit">
            ...
            <input type="password" v-model="password" class="bg-stone-100 rounded-full border-2 border-stone-500 focus:border-sky-500 focus:outline-none px-6 py-1 text-xl placeholder:text-stone-700" placeholder="Password">
